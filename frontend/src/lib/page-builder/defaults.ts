...
export function makeSection(
  ...
  const defaults: Record<SectionType, { content: Record<string, unknown>; style: SectionStyle }> = {
    ...
    text: {
      ...
      content: {
        body: 'Add your text here. Share your story, describe your offerings, or provide details about your practice.',
      },
    },
    image: {
    ...
    'two-column': {
      ...
      content: {
        leftHeadline: '',
        leftBody: 'Left column content goes here.',
        rightHeadline: '',
        rightBody: 'Right column content goes here.',
      },
    },
    services: {
  ...
  switch (slug) {
    ...
    case 'sound-on-the-river':
      return [
        makeSection('hero', {
          ...
          ctaText: 'See Upcoming Dates',
          ctaLink: '#upcoming-events',
          ctaSecondaryText: '',
          ctaSecondaryLink: '',
          backgroundImage: '/images/sound-on-river.jpg',
          overlayOpacity: 0.5,
        }),
        makeSection('two-column', {
    ...
    case 'gallery':
      return [
        makeSection('hero', {
          headline: 'Gallery',
          subheading: 'Moments from our community.',
          ctaText: '',
          ctaLink: '',
        }, { paddingY: 'lg' }),
    ...
    case 'booking':
      return [
        makeSection('hero', {
          ...
          subheading: 'Choose your practice and schedule your next visit.',
          ctaText: '',
          ctaLink: '',
        }, { paddingY: 'lg' }),
    ...
    case 'classes':
      return [
        makeSection('hero', {
          headline: 'Our Services',
          subheading: 'Yoga, massage, and sound healing — find the practice that calls to you.',
    ...
    case 'events':
      return [
        makeSection('hero', {
          headline: 'Upcoming Events',
          subheading: 'Join us for classes, workshops, and transformational experiences.',
          ctaText: '',
          ctaLink: '',
        }, { paddingY: 'lg' }),
    ...
    default:
      switch (template) {
        case 'home':
          return [
            makeSection('hero', {
              headline: 'Move. Breathe. Heal. Thrive.',
              subheading: 'Sacred Vibes offers yoga, massage, and sound healing in a community built on transformation.',
            ...
            makeSection('services', {
              eyebrow: 'What We Offer',
              headline: 'Sacred Offerings',
              subheading: 'Choose the practice that calls to you.',
              maxItems: 6,
            }),
            makeSection('events', {
              eyebrow: 'Join Us',
            ...
            makeSection('cta', {
              headline: 'Ready to begin your journey?',
              subheading: 'Your transformation starts with a single step.',
              ctaText: 'Book a Session',
              ctaLink: '/booking',
            }),
          ]
